...
import { Menu, X, ChevronDown, MapPin, Phone, Mail, Facebook, Youtube, Instagram, Music } from 'lucide-react';
import './App.css';
...
const App = () => {
  ...
  const renderPage = () => {
    switch(currentPage) {
      ...
      case 'Ministry': return <MinistryPage />;
      ...
      case 'Memorial Tribute': return <MemorialTributePage />;
      case 'CCC Family': return <CCCFamilyPage />;
      case 'Upcoming Events': return <UpcomingEventsPage />;
      case 'Giving': return <GivingPage />;
      case 'Visit Us': return <VisitUsPage />;
